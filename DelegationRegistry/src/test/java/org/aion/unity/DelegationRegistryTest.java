...
public class DelegationRegistryTest {
    ...
    public static void deployDapp() {
        ...
        byte[] dapp = avmRule.getDappBytes(DelegationRegistry.class, arguments, StakeRegistry.class, StakeRegistryListener.class, Pool.class);
