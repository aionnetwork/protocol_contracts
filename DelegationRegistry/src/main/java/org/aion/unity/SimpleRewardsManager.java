            ...
            switch (x.type) {
                ...
                case BLOCK: {
                    ...
                    for (Map.Entry<Address, Float> r : ratioOwed.entrySet()) {
                        ...
                        if (rewardsMap.containsKey(r.getKey())) {
                            rewardsMap.put(r.getKey(), rewardsMap.get(r.getKey()) + stakerReward);
                        } else {
                            rewardsMap.put(r.getKey(), stakerReward);
                        }
                    }
                    break;
                }
